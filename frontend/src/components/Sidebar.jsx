...
function Sidebar() {
  return (
    <div className='2xl:w-64 xl:w-64 lg:w-52 md:w-28 sm:w-16 w-10 relative h-screen'>
      ...
      <NavLink to={"/allorder"} className='flex justify-center items-center gap-4 border-2 border-black sm:h-16 h-10 2xl:w-44 xl:w-44 lg:w-44 md:w-16 sm:w-16 w-10 mt-48 right-0 top-8 absolute rounded-lg hover:bg-red-400'>
